...
const WeatherCard = () => {
  ...
  const { weather, isLoading, isError } = useWeather('weather')

  console.log(weather, isError, isError)
  ...
  return (
    <>
      <div className="m-4">
        ...
        <div className={`text-indigo-700 dark:text-gray-400 mt-1 ${showRecommendations ? null : 'mb-6'}`}>
